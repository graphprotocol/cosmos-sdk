...
import (
	...
	"github.com/graphprotocol/cosmos-sdk/examples/graphtoken2/types"
...
func NewGraphTokenApp(logger log.Logger, db dbm.DB, baseAppOptions ...func(*bam.BaseApp)) *GraphTokenApp {
	...
	app.eventKeeper = graphpoc.NewKeeper(app.eventMapper)

	// register message routes
	app.Router().
		AddRoute("bank", bank.NewHandler(app.coinKeeper)).
		AddRoute("ibc", ibc.NewHandler(app.ibcMapper, app.coinKeeper)).
		AddRoute("event", graphpoc.NewHandler(app.eventKeeper))
	...
	app.MountStoresIAVL(app.keyMain, app.keyAccount, app.keyIBC, app.keyEvent)
...
func MakeCodec() *wire.Codec {
	...
	// cdc.RegisterConcrete(&graphpoc.MsgRegisterEvent{}, "dk/mre", nil)
